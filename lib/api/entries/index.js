...
function configure (app, wares, ctx) {
  ...
  var express = require('express'),
    ...
    function insert_entries (req, res, next) {
      ...
      // before inserting convert dateString to UTC ISO format so that Nightscout always stores dateString in UTC ISO format, e.g. "2017-08-29T16:15:59Z"
      // downloaders of entries expect dateString in UTC ISO format and some uploaders use timezone date format, e.g. "Tue Aug 29 18:15:59 GMT+02:00 2017"
      _.forEach(req.body, function clean(e) {
                 if (e.dateString) {
